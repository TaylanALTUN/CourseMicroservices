...
namespace FreeCourse.Services.Catalog.Services
{
    internal class CourseService: ICourseService
    {
        ...
        {
            var courseList = await _courseCollection.Find(x => true).ToListAsync();
            ...
            return Response<List<CourseDto>>.Success(_mapper.Map<List<CourseDto>>(courseList), StatusCodes.Status200OK);
        }
        ...
        public async Task<Response<List<CourseDto>>> GetAllByUserIdsync(string userId)
        {
